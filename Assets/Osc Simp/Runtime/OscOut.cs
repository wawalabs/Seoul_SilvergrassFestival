...
namespace OscSimpl
{
	...
	public class OscOut : OscMonoBase
	{
		...
		public int udpBufferSize
		{
			...
			set { _udpBufferSize = Mathf.Clamp( value, OscConst.udpBufferSizeMin, OscConst.udpBufferSizeMax ); }
		}
		...
		/// </summary>
		public int messageCountSendLastFrame => _messageCountLastFrame;

		/// <summary>
		/// Gets the number of bytes send last update.
		/// </summary>
		public int byteCountSendLastFrame => _byteCountLastFrame;
		...
		void LateUpdate()
		{
			...
			// Adapt buffers size.
			if( _autoBundleMessageBuffer != null && _autoBundleMessageBuffer.capacity != _udpBufferSize ) _autoBundleMessageBuffer = new SerializedOscMessageBuffer( _udpBufferSize );
		...
		{
			if( _autoBundleMessageBuffer == null ) _autoBundleMessageBuffer = new SerializedOscMessageBuffer( _udpBufferSize );
